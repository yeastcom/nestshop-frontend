        ...
        },
        {
            ...
            cell: ({ row }) => {
                async function handleClickDelete(id: number) {
                    await adminApiClient(`/admin/cms/${id}`, {
                        method: "DELETE",
                    })

                    setData((prev) => prev.filter((c) => c.id !== id))
                    toast.success(`Usunięto stronę CMS #${id}`)
                }
                return (
                    <DropdownMenu>
                        <DropdownMenuTrigger>
                        ...
                        <DropdownMenuContent align="end" className="w-32">
                            <Link href={`/admin/cms/${row.original.id}`}><DropdownMenuItem>Edit</DropdownMenuItem></Link>
                            <DropdownMenuSeparator />
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Link href={'/admin/cms/create'}>
                        <Button variant="outline" size="sm">
                            <IconPlus />
                            <span className="hidden lg:inline">Dodaj stronę CMS</span>
                        </Button>
                    </Link>
                </div>
            </div>
